...
public class SkeletonValidator {
    ...
    public SkeletonValidator() {
        ...
        validateMethodSignature(
                "chennaiDocument:com.cts.passportService.Document,bangaloreDocument:com.cts.passportService.Document",
                "com.cts.passportService.AppConfig");

        validateClassName("com.cts.passportService.BangalorePassportOffice");
        validateMethodSignature("doPhotoVerification:void,issuePassport:void",
                "com.cts.passportService.BangalorePassportOffice");

        validateClassName("com.cts.passportService.ChennaiPassportOffice");
        validateMethodSignature("doPhotoVerification:void,issuePassport:void",
                "com.cts.passportService.ChennaiPassportOffice");
        ...
        validateMethodSignature("doPhotoVerification:void,issuePassport:void",
                "com.cts.passportService.HeadPassportOffice");
