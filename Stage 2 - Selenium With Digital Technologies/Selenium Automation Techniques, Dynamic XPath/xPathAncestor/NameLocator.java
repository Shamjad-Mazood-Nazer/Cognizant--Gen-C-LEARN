...
public class NameLocator      //DO NOT Change the class name
{
	...
	public String getNameLocator()              //DO NOT Change the method Signature
	{
       ...
       WebElement nickNameLabel = driver.findElement(By.id("nickname"));
       
       WebElement formAncestor = nickNameLabel.findElement(By.xpath("./ancestor::div"));
       
       fName = formAncestor.getText();
        driver.quit();
	...
	public static void main(String[] args)
	{
	    ...
	    String ancestorText = nameLocator.getNameLocator();
	    System.out.println("Ancestor Text: " + ancestorText);
	}
